...
// from behind. Back on the Earth, the moon is watched from the ground: rising golden over
// silver grass in the wind at dusk; high over a meadow of cosmos with fireflies; behind a
// plum branch whose blossoms catch its light; rising out of the sea, its light breaking up
// on the waves; pale above pines standing out of the mist before dawn; and back on the
// summit at dawn as it sets in the west. Away from those close-ups the moon only stops near the middle of a wall, where
...
const TG = 1369;  // silver grass in the wind, the moon rising over it at dusk
const TF = 1699;  // a meadow of cosmos at night, fireflies
const TB = 2029;  // a plum branch across the moon
const TW = 2299;  // by the sea, the moon rising out of it, its light on the water
const TK = 2689;  // pines in the mist before dawn, a pale moon
const TD = 3019;  // dawn, back on the summit
export const LOOP = TD + 161; // 53:00
...
export const LAND_ALT = 250;  // the landscapes: low hills (m)
...
export const SCENES = [
  ...
  { id: 'grass',    t: TG + 1,  ko: '억새 · 월출',           en: 'Silver grass · Moonrise' },
  { id: 'meadow',   t: TF + 1,  ko: '꽃밭 · 반딧불',          en: 'Meadow · Fireflies' },
  { id: 'branch',   t: TB + 1,  ko: '매화 가지 · 달',        en: 'Plum branch · The moon' },
  { id: 'sea',      t: TW + 1,  ko: '바다 · 윤슬',           en: 'The sea · Moonlight on the water' },
  { id: 'mist',     t: TK + 1,  ko: '안개 · 소나무',          en: 'Mist · Pines' },
...
const TRACKS = {
  ...
  earth: [[0, 1], [469, 1], [471, 0], [TG - 2, 0], [TG, 1], [LOOP, 1]],
  ...
  surface: [[0, 0], [TU, 0], [TU + 0.5, 1], [TG - 2.5, 1], [TG - 2, 0], [LOOP, 0]],
  // 1 = by the sea
  sea: [[0, 0], [TW - 2, 0], [TW - 1.5, 1], [TK - 2, 1], [TK - 1.5, 0], [LOOP, 0]],
  // 1 = standing on the ground in one of the landscapes (grass, meadow, branch, mist)
  land: [[0, 0], [TG - 2, 0], [TG - 1.5, 1], [TW - 2, 1], [TW - 1.5, 0], [TK - 2, 0], [TK - 1.5, 1], [TD - 2, 1], [TD - 1.5, 0], [LOOP, 0]],
  // what grows there: silver grass, flowers (with fireflies), the plum branch, pines
  vegGrass: [[0, 0], [TG - 2, 0], [TG - 1.5, 1], [TF - 2, 1], [TF - 1.5, 0], [LOOP, 0]],
  vegFlower: [[0, 0], [TF - 2, 0], [TF - 1.5, 1], [TB - 2, 1], [TB - 1.5, 0], [LOOP, 0]],
  vegBranch: [[0, 0], [TB - 2, 0], [TB - 1.5, 1], [TW - 2, 1], [TW - 1.5, 0], [LOOP, 0]],
  vegPine: [[0, 0], [TK - 2, 0], [TK - 1.5, 1], [TD - 2, 1], [TD - 1.5, 0], [LOOP, 0]],
  // the ground: eye height, the clearing round the viewer, the height of the grass (m)
  landEye: [[0, 1.6], [TF - 2, 1.6], [TF - 1.5, 0.95], [TB - 2, 0.95], [TB - 1.5, 1.6], [TK - 2, 1.6], [TK - 1.5, 12], [TD - 2, 12], [TD - 1.5, 1.6], [LOOP, 1.6]],
  near: [[0, 2.4], [TF - 2, 2.4], [TF - 1.5, 1.4], [TB - 2, 1.4], [TB - 1.5, 3.0], [TK - 2, 3.0], [TK - 1.5, 9.0], [TD - 2, 9.0], [TD - 1.5, 2.4], [LOOP, 2.4]],
  fieldH: [[0, 1.95], [TF - 2, 1.95], [TF - 1.5, 1.0], [LOOP, 1.0]],
  // wind: sway per metre of height; it gusts over the silver grass, breathes over the meadow
  windS: [[0, 0.3], [TF - 2, 0.3], [TF - 1.5, 0.1], [TB - 2, 0.1], [TB - 1.5, 0.07], [TK - 2, 0.07], [TK - 1.5, 0.03], [LOOP, 0.03]],
  // mist on the ground (1/m) and how fast it thins with height (m)
  mist: [[0, 0.0012], [TF - 2, 0.0012], [TF - 1.5, 0.0012], [TB - 2, 0.0012], [TB - 1.5, 0.0009], [TK - 2, 0.0009], [TK - 1.5, 0.045], [LOOP, 0.045]],
  mistH: [[0, 25], [TF - 2, 25], [TF - 1.5, 15], [TB - 2, 15], [TB - 1.5, 30], [TK - 2, 30], [TK - 1.5, 8], [LOOP, 8]],
  // depth of field (px x m) and where the focus is (m, 0 = far): the near grass goes soft;
  // behind the plum branch the moon is out of focus
  dofL: [[0, 0], [TG - 2, 0], [TG - 1.5, 10], [TF - 2, 10], [TF - 1.5, 8], [TB - 2, 8], [TB - 1.5, 14], [TW - 2, 14], [TW - 1.5, 0], [LOOP, 0]],
  focusL: [[0, 0], [TF - 2, 0], [TF - 1.5, 5], [TB - 2, 5], [TB - 1.5, 1.15], [TW - 2, 1.15], [TW - 1.5, 0], [LOOP, 0]],
  // the moon's colour over what the air does to it: golden over the silver grass and the
  // sea, blue-white over the meadow and in the mist, peach behind the plum branch
  mtR: [[0, 1], [TG - 2, 1], [TG - 1.5, 1.0], [TF - 2, 1.0], [TF - 1.5, 0.9], [TB - 2, 0.9], [TB - 1.5, 1.0], [TW - 2, 1.0], [TW - 1.5, 1.0],
    [TK - 2, 1.0], [TK - 1.5, 0.9], [TD - 2, 0.9], [TD - 1.5, 1], [LOOP, 1]],
  mtG: [[0, 1], [TG - 2, 1], [TG - 1.5, 0.93], [TF - 2, 0.93], [TF - 1.5, 0.96], [TB - 2, 0.96], [TB - 1.5, 0.9], [TW - 2, 0.9], [TW - 1.5, 0.88],
    [TK - 2, 0.88], [TK - 1.5, 0.96], [TD - 2, 0.96], [TD - 1.5, 1], [LOOP, 1]],
  mtB: [[0, 1], [TG - 2, 1], [TG - 1.5, 0.78], [TF - 2, 0.78], [TF - 1.5, 1.06], [TB - 2, 1.06], [TB - 1.5, 0.78], [TW - 2, 0.78], [TW - 1.5, 0.66],
    [TK - 2, 0.66], [TK - 1.5, 1.05], [TD - 2, 1.05], [TD - 1.5, 1], [LOOP, 1]],
  ...
  // specks drifting in the air that catch the moonlight
  motes: [[0, 0], [TG - 2, 0], [TG - 1.5, 0.5], [TF - 2, 0.5], [TF - 1.5, 1.0], [TB - 2, 1.0], [TB - 1.5, 1.2], [TW - 2, 1.2], [TW - 1.5, 0],
    [TK - 2, 0], [TK - 1.5, 0.6], [TD - 2, 0.6], [TD - 1.5, 0], [LOOP, 0]],
  // a night photograph's split toning in the landscapes and by the sea
  tone: [[0, 0], [TG - 2, 0], [TG - 1.5, 0.6], [TF - 2, 0.6], [TF - 1.5, 0.35], [TB - 2, 0.35], [TB - 1.5, 0.7], [TW - 2, 0.7], [TW - 1.5, 0.45],
    [TK - 2, 0.45], [TK - 1.5, 0.2], [TD - 2, 0.2], [TD - 1.5, 0], [LOOP, 0]],
  // colour at night: 1 = rods take over as they would; the meadow keeps its colours
  mesopic: [[0, 1], [TG - 2, 1], [TG - 1.5, 0.8], [TF - 2, 0.8], [TF - 1.5, 0.35], [TB - 2, 0.35], [TB - 1.5, 0.6], [TW - 2, 0.6], [TW - 1.5, 1], [LOOP, 1]],
  terrainOn: [[0, 1], [392, 1], [393.5, 0], [TD - 2, 0], [TD, 1], [LOOP, 1]],
  camAlt: [[0, EYE_ALT], [392, EYE_ALT], [394.5, 3300], [430, 5600], [468, 23000], [472, 23000], [TG - 2, 23000], [TG - 1.5, LAND_ALT],
    [TW - 2, LAND_ALT], [TW - 1.5, SEA_EYE], [TK - 2, SEA_EYE], [TK - 1.5, LAND_ALT], [TD - 2, LAND_ALT], [TD - 1.5, EYE_ALT], [LOOP, EYE_ALT]],
  ...
  sunAz: [[0, 86], [TM, 86], [TG - 2, 86], [TG - 1.5, 180], [TF - 2, 180], [TF - 1.5, 86], [TK - 2, 86], [TK - 1.5, -86], [LOOP, -86]],
  sunEl: [[0, -2.6], [55, -4.4], [120, -8.0], [175, -12.4], [235, -17.5], [300, -20], [TM, -21], [TG - 2, -21],
    [TG - 1.5, -5.5], [TG + 150, -7.5], [TF - 2, -10], [TF - 1.5, -18], [TB - 2, -18], [TB - 1.5, -16], [TW - 2, -16], [TW - 1.5, -21], [TK - 2, -21],
    [TK - 1.5, -14], [TD - 2, -12.5], [TD - 1.5, -15], [TD + 1, -15], [TD + 89, -10], [TD + 144, -6.6], [LOOP, -6.0]],
  ...
  logAlt: [
    ...
    [TS + 1, km(22)], [TU, km(19)], [TG - 2, km(19)], [TG - 1.5, ang(11)], [LOOP, ang(11)],
  ],
  ...
  faceLat: [[0, -4], [TC, -4], [TC + 45, 8], [TO - 6, 9], [TO, 9], [TO + 1, -28], [TA - 6, -27], [TA, -27],
    [TA + 1, 8], [TA + 20, 10.6], [TA + 35, 10.6], [TA + 67, 10.5], [TS, 10.5], [TS + 1, 6.78], [TU, 6.9], [TG - 2, 6.9], [TG - 1.5, -4], [LOOP, -4]],
  ...
  tgtAz: [[0, 0], [484, 0], [496, -22], [502, -22], [514, -64], [520, -64], [530, -90], [536, -90],
    ...
    [628, -338], [634, -338], [646, -360], [TC, -360], [TC + 45, -405], [TO, -405], [TO + 1, -360], [TG - 2, -360],
    [TG - 1.5, -368], [TF - 2, -363], [TF - 1.5, -348], [TB - 2, -344], [TB - 1.5, -364], [TW - 2, -362], [TW - 1.5, -360], [TK - 2, -360],
    [TK - 1.5, -354], [TD - 2, -350], [TD, 0], [LOOP, 0]],
  tgtEl: [[0, 9], [455, 9], [469, 12], [TC, 12], [TC + 45, 1], [TO, 1], [TO + 1, 60], [TA - 6, 56], [TA, 56],
    [TA + 1, 8], [TA + 20, 3], [TA + 37, 0], [TS, 0], [TS + 1, -90], [TG - 2, -90],
    [TG - 1.5, 0.6], [TG + 70, 3.2], [TF - 2, 11], [TF - 1.5, 14], [TB - 2, 18], [TB - 1.5, 16.5], [TW - 2, 17.5],
    [TW - 1.5, 1.8], [TW + 90, 5.5], [TK - 2, 13], [TK - 1.5, 21], [TD - 2, 17], [TD - 1.5, 9], [LOOP, 9]],
  ...
  sunLat: [[0, -4], [TM, -4], [TC, 0], [TC + 45, 1.5], [TO, 1.5], [TO + 1, -1.5], [TA, -1.5], [TA + 1, 0], [TA + 25, 0.5], [TS, 0.5], [TS + 1, 0.5],
    [TU, 1.0], [TG - 2, 1.0], [TG - 1.5, -4], [LOOP, -4]],
  sunLon: [[0, 5], [TM, 5], [TC, 5], [TC + 45, 90], [TO - 6, 88], [TO, 88], [TO + 1, 48], [TA - 6, 46], [TA, 46],
    [TA + 1, 73], [TA + 25, 71.0], [TA + 40, 71.0], [TS - 6, 64.5], [TS, 64.5], [TS + 1, 66], [TU, 58], [TG - 2, 58], [TG - 1.5, 5], [LOOP, 5]],
  earthLat: [[0, -4], [LOOP, -4]],
  earthLon: [[0, 5], [LOOP, 5]],
  ...
  meteors: [[0, 0], [100, 0], [140, 0.03], [370, 0.03], [385, 0], [TG - 2, 0], [TG + 150, 0.01], [TF, 0.03], [TK - 2, 0.03], [TK, 0], [TD - 2, 0], [TD, 0.02], [TD + 45, 0], [LOOP, 0]],
  shower: [[0, 0], [258, 0], [272, 1.2], [312, 1.2], [326, 0], [LOOP, 0]],
  twinkle: [[0, 0.3], [TG - 2, 0.3], [TF, 0.8], [TW, 1.0], [TK - 2, 1.0], [TK, 0.3], [LOOP, 0.3]],
  ...
  mie: [[0, 1.6], [120, 1.35], [220, 1.1], [TM, 1.0], [TG - 2, 1.0], [TG - 1.5, 1.6], [TF - 2, 1.6], [TF - 1.5, 1.2], [TB - 2, 1.2], [TB - 1.5, 1.3], [TW - 2, 1.3],
    [TW - 1.5, 1.7], [TK - 2, 1.7], [TK - 1.5, 1.8], [TD - 2, 1.8], [TD + 1, 1.5], [LOOP, 1.8]],
  ...
  cloudCov: [[0, 0.32], [150, 0.44], [215, 0.24], [370, 0.3], [386, 0.28], [393, 0.35], [398, 0.8], [406, 0.9], [440, 0.82], [TM, 0.82],
    [TG - 2, 0.82], [TG - 1.5, 0.3], [TF - 2, 0.3], [TF - 1.5, 0.12], [TB - 2, 0.12], [TB - 1.5, 0.18], [TW - 2, 0.18], [TW - 1.5, 0.2],
    [TK - 2, 0.2], [TK - 1.5, 0.3], [TD - 2, 0.3], [TD + 1, 0.22], [LOOP, 0.2]],
  cloudDens: [[0, 0.0075], [388, 0.0075], [393, 0.02], [402, 0.02], [415, 0.009], [TG - 2, 0.009], [TG - 1.5, 0.006], [TD - 2, 0.006], [TD + 1, 0.0065], [LOOP, 0.0065]],
  ...
  blur: [[0, 10], [14, 10], [40, 0],
    ...
    [TG - 9, 0], [TG - 3, 24], [TG + 1, 24], [TG + 16, 0], [TF - 9, 0], [TF - 3, 24], [TF + 1, 24], [TF + 16, 0],
    [TB - 9, 0], [TB - 3, 24], [TB + 1, 24], [TB + 16, 0], [TW - 9, 0], [TW - 3, 24], [TW + 1, 24], [TW + 16, 0],
  ...
  fade: [[0, 0], [10, 1], [464, 1], [469, 0.2], [474, 1],
    ...
    [TG - 10, 1], [TG - 3, 0], [TG + 1, 0], [TG + 10, 1], [TF - 10, 1], [TF - 3, 0], [TF + 1, 0], [TF + 10, 1],
    [TB - 10, 1], [TB - 3, 0], [TB + 1, 0], [TB + 10, 1], [TW - 10, 1], [TW - 3, 0], [TW + 1, 0], [TW + 10, 1],
  ...
  ev: [[0, -0.3], [54, -0.246], [71, -0.074], [83, 0.338], [97, 0.621], [122, 1.393], [133, 2.087], [139, 2.663], [152, 3.138], [160, 2.799], [163, 2.253], [165, 1.392], [166, 0.99], [169, 0.268], [172, 0.123], [185, 0.122], [200, 0], [300, 0.1],
    ...
    [TU, 5.0], [TU + 40, 4.8], [TU + 70, 4.8], [TU + 170, 3.6], [TG - 2, 3.6], [TG - 1.5, 1.0], [TF - 2, 1.0], [TF - 1.5, 0.4], [TB - 2, 0.4],
    [TB - 1.5, 0.2], [TW - 2, 0.2], [TW - 1.5, 0.0], [TK - 2, 0.0], [TK - 1.5, -0.2], [TD - 2, -0.2],
    [TD + 1, 0.1], [TD + 13, 0.147], [TD + 17, 0.201], [TD + 28, 0.105], [TD + 41, 0.305], [TD + 46, 1.087], [TD + 52, 1.707], [TD + 81, 2.186], [TD + 100, 1.859], [TD + 107, 1.481], [TD + 117, 1.041], [TD + 141, 0.379], [TD + 147, 0.174], [TD + 151, 0.007], [LOOP, 0.0]],
  vig: [[0, 0.72], [466, 0.72], [474, 0.55], [TG - 2, 0.55], [TG + 1, 0.72], [LOOP, 0.72]],
  bloom: [[0, 0.5], [TM, 0.5], [475, 0.2], [TS, 0.2], [TS + 1, 0.1], [TG - 2, 0.1], [TG + 1, 0.5], [TF - 2, 0.5], [TF - 1.5, 0.7], [TB - 2, 0.7],
    [TB - 1.5, 0.85], [TW - 2, 0.85], [TW - 1.5, 0.5], [LOOP, 0.5]],
  halation: [[0, 0.55], [TM, 0.55], [475, 0.2], [TS, 0.2], [TS + 1, 0.0], [TG - 2, 0.0], [TG + 1, 0.55], [LOOP, 0.55]],
  glow: [[0, 0.6], [TM, 0.6], [475, 0.1], [TG - 2, 0.1], [TG + 1, 0.6], [TB - 2, 0.6], [TB - 1.5, 1.0], [TW - 2, 1.0], [TW - 1.5, 0.6], [TK - 2, 0.6], [TK - 1.5, 0.9], [TD - 2, 0.9], [TD - 1.5, 0.6], [LOOP, 0.6]],
  refr: [[0, 0.9], [LOOP, 0.9]],
  shimmer: [[0, 0.5], [120, 0.15], [200, 0.0], [TG - 2, 0.0], [TG - 1.5, 0.45], [TG + 150, 0.1], [TF - 2, 0.0], [TW - 2, 0.0], [TW - 1.5, 0.4], [TW + 150, 0.1], [TK - 2, 0.0],
    [TD + 1, 0.0], [TD + 89, 0.2], [LOOP, 0.5]],
  // the moon out of focus behind the plum branch
  limbSoft: [[0, 0.12], [60, 0.12], [120, 0], [TB - 2, 0], [TB - 1.5, 0.3], [TW - 2, 0.3], [TW - 1.5, 0], [LOOP - 45, 0], [LOOP, 0.1]],
  lodBias: [[0, 1.2], [50, 1.2], [110, 0], [TB - 2, 0], [TB - 1.5, 2.2], [TW - 2, 2.2], [TW - 1.5, 0], [LOOP - 45, 0], [LOOP, 1.0]],
