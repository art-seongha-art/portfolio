...
export function initUI(ctx) {
  ...
  window.addEventListener('keydown', (e) => {
    ...
    else if (/^[0-9-]$/.test(k) || /^[qwerQWER]$/.test(k)) {
      // scenes: 1-9, then 0 and - for the tenth and eleventh, q w e r for the rest
      const i = k === '0' ? 9 : k === '-' ? 10 : /[qQ]/.test(k) ? 11 : /[wW]/.test(k) ? 12 : /[eE]/.test(k) ? 13 : /[rR]/.test(k) ? 14 : +k - 1;
