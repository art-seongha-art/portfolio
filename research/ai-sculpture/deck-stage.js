...
(() => {
  ...
  const stylesheet = `
    ...
    /* Bottom thumbnail rail override 20260619
       In the paper viewer, the host already has a left navigation menu.
       Move deck thumbnails to a compact horizontal strip at the bottom. */
    .rail {
      left: 0 !important;
      right: 0 !important;
      top: auto !important;
      ...
      height: var(--deck-rail-h, 96px) !important;
    ...
    .rail::-webkit-scrollbar { height: 8px !important; width: 8px !important; }
    .thumb {
    ...
    .thumb[data-drop="before"]::before { left: -5px !important; top: 0 !important; bottom: 0 !important; width: 3px !important; height: auto !important; }
    .thumb[data-drop="after"]::before { right: -5px !important; top: 0 !important; bottom: 0 !important; width: 3px !important; height: auto !important; left: auto !important; }
    .rail-resize { display: none !important; }
    .rail[data-user-hidden] { transform: translateY(100%) !important; }
    :host([data-rail-anim]) .rail { transition: transform 200ms cubic-bezier(.3,.7,.4,1) !important; }
    :host([data-rail-anim]) .stage { transition: bottom 200ms cubic-bezier(.3,.7,.4,1) !important; }
  ...
  class DeckStage extends HTMLElement {
    ...
    _fit() {
      ...
      if (this.hasAttribute('noscale')) {
        ...
        if (stage) { stage.style.left = '0'; stage.style.bottom = '0'; }
        if (this._overlay) { this._overlay.style.marginLeft = '0'; this._overlay.style.bottom = '22px'; }
        return;
      }
      ...
      if (stage) {
        stage.style.left = '0';
        stage.style.bottom = railH + 'px';
      }
      // Host paper viewer already has a left nav; thumbnails live below, so
      // keep the overlay horizontally centred and lift it above the strip.
      if (this._overlay) {
        this._overlay.style.marginLeft = '0';
        this._overlay.style.bottom = (railH + 18) + 'px';
      }
      const vw = window.innerWidth;
      const vh = Math.max(1, window.innerHeight - railH);
